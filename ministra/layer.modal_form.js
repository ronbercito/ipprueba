...
ModalForm.prototype._init = function () {
    ...
    this._container = create_block_element("modal_container", this._dom_obj);

    this._title_dom_obj = create_block_element("title", this._container);
    this._title_dom_obj.innerHTML = this._title;
    this._status_dom_obj = create_block_element("status", this._container);

    if (this._text) {
        this._text_dom_obj = create_block_element("text", this._container);
        this._text_dom_obj.innerHTML = this._text;
    }

    this._items_block = create_block_element("", this._container);
    this._buttons_block = create_block_element("buttons", this._container);
    this.hide();
